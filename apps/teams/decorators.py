...
from .roles import is_admin, is_coordinator, is_member
...
def team_coordinator_required(view_func):
    """Require coordinator role or higher (admin)."""
    return _get_decorated_function(view_func, is_coordinator)
