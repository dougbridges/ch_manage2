"""
Django settings for Church Management Second project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-KxpHyXUTVA3u0WhZJgP6QS7dOmJVB1uhUmpLv8WB")
...
WSGI_APPLICATION = "ch_manage2.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="ch_manage2"),
...
if USE_S3_MEDIA:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="ch_manage2-media")
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="dougbridges@gmail.com")
...
EMAIL_SUBJECT_PREFIX = "[Church Management Second] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Church Management Second",
    "DESCRIPTION": "Quick to Setup Church Management Software",  # noqa: E501
    "VERSION": "0.1.0",
...
ASGI_APPLICATION = "ch_manage2.asgi.application"
CHANNEL_LAYERS = {
    "default": {
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("Church Management Second"),
    "URL": "http://localhost:8000",
    "DESCRIPTION": gettext_lazy("Quick to Setup Church Management Software"),  # noqa: E501
    "IMAGE": "https://upload.wikimedia.org/wikipedia/commons/2/20/PEO-pegasus_black.svg",
    "KEYWORDS": "SaaS, django",
    "CONTACT_EMAIL": "dougbridges@gmail.com",
}

# set this to True in production to have URLs generated with https instead of http
USE_HTTPS_IN_ABSOLUTE_URLS = env.bool("USE_HTTPS_IN_ABSOLUTE_URLS", default=False)

ADMINS = ["dougbridges@gmail.com"]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "ch_manage2": {
            "handlers": ["console"],
            "level": env("CH_MANAGE2_LOG_LEVEL", default="INFO"),
        },
        "pegasus": {
            "handlers": ["console"],
